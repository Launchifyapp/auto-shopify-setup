...
export async function setupShopGraphQL({ shop, token }: { shop: string; token: string }) {
  try {
    ...
    for (const [handle, group] of Object.entries(productsByHandle)) {
      ...
      // Images au format ProductImageInput
      ...
      // Variantes au format ProductVariantInput
      ...
      // Envoie la mutation productCreate à Shopify GraphQL
      try {
    ...
    console.log("Erreur globale setupShopGraphQL:", err);
  }
}
